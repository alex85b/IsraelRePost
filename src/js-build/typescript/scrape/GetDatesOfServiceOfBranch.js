...
const getDatesOfServiceOfBranch = (cookies, urlAttributes, headers) => __awaiter(void 0, void 0, void 0, function* () {
    const searchAvailableDates = new SearchAvailableDates_1.SearchAvailableDates();
    const datesResponse = yield searchAvailableDates.makeRequest({
