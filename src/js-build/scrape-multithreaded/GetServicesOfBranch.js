...
const getServicesOfBranch = (cookies, urlAttributes, headers, useProxy, proxyUrl, proxyAuth) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const locationGetServices = new LocationGetServices_1.LocationGetServices();
        const servicesResponse = yield locationGetServices.makeRequest(useProxy, proxyUrl, proxyAuth, {
