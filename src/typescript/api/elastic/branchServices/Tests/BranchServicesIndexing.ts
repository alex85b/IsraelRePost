import { omit } from "../../base/ElasticsearchUtils";
import {
	BranchServicesIndexing,
	IDocumentBranch,
	INewServiceRecord,
} from "../BranchServicesIndexing";
...
export const construct = () => {
	...
	if (!bServicesIndex)
		throw Error(
			"[construct] Test Failed, BranchServicesIndexing is null Or undefined"
		);
	else
		console.log("[construct] BranchServicesIndexing is not null / undefined");
...
export const fetchAllBranches = async () => {
	...
	console.log(
		...
		allBranches.data.hits.hits.length
	);
...
export const branchesWithoutServices = async () => {
	...
	console.log(
		"[branchesWithoutServices] metadata : ",
		omit(bWithoutServices, "data")
	);
...
export const getBranchesExcluding = async () => {
	...
	console.log(
		"[getBranchesExcluding] metadata : ",
		omit(branchesExcluding, "data")
	);
...
export const bulkAddBranches = async () => {
	...
	console.log(
		...
		bulkAddReport.data.items.length
	);
};
...
export const updateBranchServices = async () => {
	...
	console.log(
		"[updateBranchServices] metadata : ",
		omit(successfullyUpdated, "data")
	);
	console.log(
