...
import { buildServicesCallConfig } from "../FetchServicesConfig";
...
export const makeServicesRequest = async () => {
	...
	const services = new RequestServicesResponse.Builder()
...
export const makeServicesRequestWithProxy = async () => {
	...
	console.log(
		"[makeServicesRequestWithProxy] path to proxy file path : ",
		proxyFilepath
	);
	...
	const services = new RequestServicesResponse.Builder()
		...
		.build();
	console.log(
		"[makeServicesRequestWithProxy] services : ",
		services.toString()
	);
	return services.getServices();
};
