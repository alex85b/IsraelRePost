import { ISingleErrorQueryResponse } from '../../../data/elastic/ErrorIndexService';
import {
...
export const addUpdateErrorRecord = async () => {
	console.log('** (2) Update-Error Records Repository | Add Update Error Record **');
	const eRepo: IUpdateErrorRecordsRepository = new UpdateErrorRecordsRepository();
	...
	console.log('[addUpdateErrorRecord] addUpdateErrorRecord response : ', response);
};
