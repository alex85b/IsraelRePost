...
export const constructNewMemoryView = async () => {
	...
	const uint8ArrayTwoCells: MemoryView = memoryBuilder
		...
		.neededCellAmount(2)
		.build();
	console.log('[constructNewMemoryView] uint8ArrayTwoCells : ', uint8ArrayTwoCells);
	console.log(
	...
	const uint16ArrayOneCell: MemoryView = memoryBuilder
		...
		.neededCellAmount(1)
		.build();
	console.log('[constructNewMemoryView] uint16ArrayOneCell : ', uint16ArrayOneCell);
	console.log(
	...
	const uint32ArrayOneCell: MemoryView = memoryBuilder
		...
		.neededCellAmount(3)
		.build();
	console.log('[constructNewMemoryView] uint32ArrayOneCell : ', uint32ArrayOneCell);
	console.log(
