...
import { IpManagerContinuesMessages } from '../../../../../services/updateAppointments/helpers/threadCommunication/Messages';
import {
	HandleStartEndpoint,
	...
	IEndpointRestart,
	IEndpointStarter,
} from '../../../../../services/updateAppointments/workerThreads/ipManager/MessageHandler';
...
if (!workerData.proxyEndpoint)
	throw Error(logMessage.createLogMessage({ subject: 'Invalid workerData - No proxyEndpoint' }));
...
handleStartEndpoint.configure({
	...
	'updater-done': new HandleUpdaterDone({ workers: handleStartEndpoint, threadId }),
});
