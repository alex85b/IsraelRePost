...
} from '../../../../../services/updateAppointments/helpers/updateServicesRecord/ConstructServicesRecord';
...
export const testDepleteContinue = async () => {
	console.log('** (1) Test Construct Services Record | Test Deplete Continue **');

	const branchesRepository: IPostofficeBranchesRepository = new PostofficeBranchesRepository();
	const errorRepository: IUpdateErrorRecordsRepository = new UpdateErrorRecordsRepository();
	...
	console.log(
		...
		requestTracker.resetTracking({ sharedLimit: 15, resetLocalMemory: true }) ?? 'Null'
	);
...
export const testDepleteContinueUseProxy = async () => {
	console.log('** (2) Test Construct Services Record | Test Deplete Continue Use Proxy **');
