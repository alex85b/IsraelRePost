...
export const testMultiThreadedDepletedTracker = async () => {
	console.log(
		"** (2) Test Depleted Claim Tracker | Test Multi Threaded Depleted Tracker **"
	);
	const depletedTracker: ITrackDepletedClaims = new DepletedClaimsTracker();
