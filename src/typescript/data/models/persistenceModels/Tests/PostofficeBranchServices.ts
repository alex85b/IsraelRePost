...
export const constructNewServiceRecord = async () => {
	...
	const branchServices: IPostofficeBranchServices =
...
export const useServiceRecord = async () => {
	...
	if (servicesModel) {
		console.log(
			"[useServiceRecord] servicesModel toString : ",
			servicesModel.toString()
		);
		console.log(
	...
	const { faults: emptyFaults, branchServices: emptyServicesModel } =
		emptyServicesArray;
